...
var pJS = function(tag_id, params){
    ...
    var now;
    var then = Date.now();
    var interval = 1000 / pJS.fps;
    var delta;

    pJS.fn.vendors.draw = function(step, force){
    ...
    pJS.fn.vendors.checkBeforeDraw = function(force){
    ...
    pJS.fn.vendors.init = function(force){

        force = typeof force !== 'undefined' ? force : false;

        pJS.active = document.hasFocus();
    ...
    pJS.fn.vendors.start = function(){
        ...
        if(isInArray('image', pJS.particles.shape.type)){
            ...
            pJS.fn.vendors.checkBeforeDraw(true);
        }
...
window.particlesJS = function(tag_id, params){
    ...
    /* launch particle.js */
    if(canvas != null){
        var instance = new pJS(tag_id, params);
...
window.particlesJS.pause = function(instance) {
    instance.active = false;
    instance.paused = true;
};

window.particlesJS.resume = function(instance) {
